  ...
  return (
    <main className="w-full max-w-4xl mx-auto px-4 py-12">
      <div className="bg-white p-8 rounded-2xl shadow-lg text-center">
        ...
        {/* Heading */}
        <h1 className="text-[32px] font-[600] text-[#006a63] mb-2 font-['Poppins']">{t('submitted.title')}</h1>
        ...
        <div className="bg-[#eff4ff] border border-gray-300 rounded-xl p-6 mb-8 max-w-md mx-auto">
          <span className="text-[14px] text-gray-600 block mb-1 font-['Inter']">{t('submitted.trackingLabel')}</span>
          <span className="text-[24px] font-[600] text-[#00236f] tracking-widest font-mono font-['Poppins']">{referenceNumber || '—'}</span>
        </div>

        {/* Action Buttons */}
        <div className="flex flex-col gap-3 max-w-md mx-auto">
          <button onClick={handleDownload} className="w-full py-4 bg-[#00236f] text-white font-bold rounded-xl hover:opacity-90 transition-all font-['Poppins']">
            {t('submitted.downloadPdf')}
          </button>
          <Link 
            to="/"
      ...
      <div className="mt-8 bg-white p-6 rounded-xl shadow-sm border border-gray-300">
        <h2 className="text-[20px] font-[600] text-[#00236f] mb-4 font-['Poppins']">{t('submitted.whatNext')}</h2>
        <div className="space-y-4">
          <div className="flex items-start gap-4">
            ...
            <div>
              <h3 className="font-semibold text-gray-800 font-['Inter'] mb-1">{t('submitted.verification')}</h3>
              <p className="text-sm text-gray-600 font-['Inter']">{t('submitted.verificationText')}</p>
            </div>
          </div>
          <div className="flex items-start gap-4">
            <div className="w-8 h-8 bg-[#d9e3f6] rounded-full flex items-center justify-center flex-shrink-0">
            ...
            <div>
              <h3 className="font-semibold text-gray-800 font-['Inter'] mb-1">{t('submitted.assignment')}</h3>
              <p className="text-sm text-gray-600 font-['Inter']">{t('submitted.assignmentText')}</p>
            </div>
          </div>
          <div className="flex items-start gap-4">
            <div className="w-8 h-8 bg-[#d9e3f6] rounded-full flex items-center justify-center flex-shrink-0">
            ...
            <div>
              <h3 className="font-semibold text-gray-800 font-['Inter'] mb-1">{t('submitted.updates')}</h3>
              <p className="text-sm text-gray-600 font-['Inter']">{t('submitted.updatesText')}</p>
            </div>
          </div>
        </div>
      </div>
