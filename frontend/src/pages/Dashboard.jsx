...
const Dashboard = () => {
  return (
    <div className="flex">
      <AdminSidebar />
      <main className="ml-64 flex-1 max-w-[1280px] mx-auto px-4 md:px-8 py-8 text-slate-900">
      <section className="space-y-8">
        <header className="bg-white p-6 rounded-[28px] shadow-sm flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
          <div>
            ...
            <h1 className="mt-3 text-3xl md:text-4xl font-semibold text-[#00236f]">Welcome back, Officer Phiri</h1>
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4">
            <div className="text-right sm:text-left">
              <p className="font-semibold text-slate-900">Lumbadzi Command Center</p>
              <p className="text-sm text-slate-500">Central Region, Malawi</p>
            </div>
            <div className="w-16 h-16 rounded-full overflow-hidden border-2 border-[#1e3a8a]">
              <img
                src="https://lh3.googleusercontent.com/aida-public/AB6AXuArfCtBwau9i-Rh5TAUUzYFP-NqMD3YxEN2OO8BIY51K6624NbaQTLly0QhxD0bm3ja_fF_lBBE14H_WgrOBEVqJH_YWUlfoJAU5yJ2zY4mizHIvzoPUPoM8oGTQHX7JCcRaJr8sExdsoXbU6EiWk4Mm-_qz8E788xjTzwYeekS8ZIKB7jkw8A64Bd1Gx6C70LOKMWwCHaIXShTjOAjyxV_QOGKSkxiKwtUC929YijN35tM2uTaIpXhnjCTji6hl-BTA_FHVDo86g"
                alt="Headshot of Officer Phiri in a professional setting with Malawian flags in the background"
        ...
        <section aria-labelledby="dashboard-summary" className="grid gap-5 grid-cols-1 md:grid-cols-3 xl:grid-cols-5">
          <article className="bg-white rounded-[28px] shadow-sm p-6 border border-slate-200">
            ...
            <div className="mt-4 flex items-end justify-between gap-4">
              <p className="text-3xl font-semibold text-[#00236f]">1,284</p>
          ...
          <article className="bg-white rounded-[28px] shadow-sm p-6 border border-slate-200">
            ...
            <div className="mt-4 flex items-end justify-between gap-4">
              <p className="text-3xl font-semibold text-[#00236f]">342</p>
          ...
          <article className="rounded-[28px] bg-[#fee2e2] shadow-sm p-6 border border-[#fecaca]">
            ...
            <div className="mt-4 flex items-end justify-between gap-4">
              <p className="text-3xl font-semibold text-[#991b1b]">14</p>
          ...
          <article className="bg-white rounded-[28px] shadow-sm p-6 border border-slate-200">
            ...
            <div className="mt-4 flex items-end justify-between gap-4">
              <p className="text-3xl font-semibold text-[#006a63]">896</p>
          ...
          <article className="bg-white rounded-[28px] shadow-sm p-6 border border-slate-200">
            ...
            <div className="mt-4 flex items-end justify-between gap-4">
              <p className="text-3xl font-semibold text-[#8b5cf6]">32</p>
              <span className="rounded-full bg-[#fde68a] px-3 py-1 text-[11px] font-semibold text-[#78350f]">URGENT</span>
            </div>
          </article>
        </section>
        ...
        <section className="grid gap-5 xl:grid-cols-[5fr_7fr]">
          <article className="bg-white rounded-[28px] shadow-sm p-6 flex flex-col">
            ...
            <div className="relative flex-1 overflow-hidden rounded-[24px] bg-slate-100 p-4 flex items-center justify-center">
              <img
              ...
              <div className="absolute bottom-4 left-4 rounded-2xl bg-white/85 backdrop-blur p-3 text-[11px] shadow-sm">
                <p className="font-semibold text-slate-900 border-b border-slate-200 pb-2 mb-2">Alert Intensity</p>
                <div className="flex items-center gap-2 text-slate-600"><span className="h-2 w-2 rounded-full bg-[#991b1b]" /> High Risk</div>
                <div className="mt-2 flex items-center gap-2 text-slate-600"><span className="h-2 w-2 rounded-full bg-[#facc15]" /> Moderate</div>
              </div>
            </div>
          </article>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <div className="h-2 rounded-full bg-slate-200 overflow-hidden">
                    <div className="h-full rounded-full bg-[#00236f]" style={{ width: '42%' }} />
                  </div>
                </div>
                <div>
                  <div className="mb-2 flex justify-between text-xs font-semibold text-slate-600">
                  ...
                  <div className="h-2 rounded-full bg-slate-200 overflow-hidden">
                    <div className="h-full rounded-full bg-[#00236f]" style={{ width: '28%' }} />
                  </div>
                </div>
                <div>
                  <div className="mb-2 flex justify-between text-xs font-semibold text-slate-600">
                  ...
                  <div className="h-2 rounded-full bg-slate-200 overflow-hidden">
                    <div className="h-full rounded-full bg-[#00236f]" style={{ width: '15%' }} />
                  </div>
                </div>
              </div>
            </article>
            ...
            <div className="grid gap-5 md:grid-cols-2">
              <article className="bg-white rounded-[28px] shadow-sm p-6 flex flex-col items-center text-center">
                ...
                <div className="mt-4 space-y-2 text-xs text-slate-700">
                  <div className="flex items-center gap-2 justify-center"><span className="h-2 w-2 rounded-full bg-[#00236f]" /> Lilongwe (45%)</div>
                  <div className="flex items-center gap-2 justify-center"><span className="h-2 w-2 rounded-full bg-[#006a63]" /> Blantyre (30%)</div>
                </div>
              </article>
        ...
        <section className="grid gap-5 xl:grid-cols-[2.4fr_1fr]">
          <article className="bg-white rounded-[28px] shadow-sm p-6">
            ...
            <div className="space-y-4">
              <div className="group flex items-center gap-4 rounded-[24px] border border-slate-200 p-4 hover:bg-slate-50 transition">
                <div className="flex h-10 w-10 items-center justify-center rounded-full bg-[#fee2e2] text-[#991b1b]">
                  <span className="material-symbols-outlined" aria-hidden="true" style={{ fontVariationSettings: "'FILL' 1" }}>priority_high</span>
                </div>
                <div className="min-w-0 flex-1">
                  <p className="font-semibold text-slate-900">Emergency Alert - Lilongwe Sector 4</p>
                  <p className="text-sm text-slate-500">Immediate response requested for incident #9928.</p>
                </div>
                <span className="text-[11px] text-slate-500 group-hover:text-[#00236f]">2 mins ago</span>
              </div>

              <div className="group flex items-center gap-4 rounded-[24px] border border-slate-200 p-4 hover:bg-slate-50 transition">
                <div className="flex h-10 w-10 items-center justify-center rounded-full bg-[#d1fae5] text-[#047857]">
                  <span className="material-symbols-outlined" aria-hidden="true" style={{ fontVariationSettings: "'FILL' 1" }}>check_circle</span>
                </div>
                <div className="min-w-0 flex-1">
                  <p className="font-semibold text-slate-900">Case Resolved - Incident #8812</p>
                  <p className="text-sm text-slate-500">Officer Banda successfully closed the investigation.</p>
                </div>
                <span className="text-[11px] text-slate-500 group-hover:text-[#00236f]">45 mins ago</span>
              </div>

              <div className="group flex items-center gap-4 rounded-[24px] border border-slate-200 p-4 hover:bg-slate-50 transition">
                <div className="flex h-10 w-10 items-center justify-center rounded-full bg-[#e0e7ff] text-[#1e3a8a]">
                  <span className="material-symbols-outlined" aria-hidden="true" style={{ fontVariationSettings: "'FILL' 1" }}>description</span>
                </div>
                <div className="min-w-0 flex-1">
                  <p className="font-semibold text-slate-900">New Report Filed - Zomba District</p>
                  <p className="text-sm text-slate-500">Anonymous report regarding workplace discrimination.</p>
                </div>
                <span className="text-[11px] text-slate-500 group-hover:text-[#00236f]">1 hour ago</span>
              </div>
            </div>
          </article>
          ...
          <aside className="bg-white rounded-[28px] shadow-sm p-6">
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between rounded-[20px] bg-slate-50 p-4">
                <div className="flex items-center gap-3">
                  <span className="h-2 w-2 rounded-full bg-[#006a63]" aria-hidden="true" />
                  <span className="font-medium text-slate-900">Lilongwe Central</span>
                </div>
              ...
              <div className="flex items-center justify-between rounded-[20px] bg-slate-50 p-4">
                <div className="flex items-center gap-3">
                  <span className="h-2 w-2 rounded-full bg-[#006a63]" aria-hidden="true" />
                  <span className="font-medium text-slate-900">Blantyre South</span>
                </div>
                <span className="rounded-full bg-[#d1fae5] px-3 py-1 text-[11px] font-semibold text-[#047857]">ACTIVE</span>
              </div>
              <div className="flex items-center justify-between rounded-[20px] bg-slate-50 p-4">
                <div className="flex items-center gap-3">
                  <span className="h-2 w-2 rounded-full bg-[#fde68a]" aria-hidden="true" />
                  <span className="font-medium text-slate-900">Mzuzu North</span>
                </div>
                <span className="rounded-full bg-[#fde9a4] px-3 py-1 text-[11px] font-semibold text-[#92400e]">BUSY</span>
              </div>
            </div>
            ...
            <div className="mt-6 rounded-[24px] border border-[#bbf7d0] bg-[#f0fdf4] p-4">
              ...
              <p className="mt-2 text-sm leading-6 text-[#065f46]">System performing within Malawi government security protocols. Last audit: 12 Oct 2024.</p>
            </div>
          </aside>
        </section>
      </section>
