const ReportStep5 = () => {
  return (
    <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-300">
      ...
      <div className="border-2 border-dashed border-[#d9e3f6] rounded-xl p-12 text-center hover:bg-[#f8f9ff] hover:border-[#00236f] transition-all cursor-pointer group">
      ...
      <div className="mt-8 space-y-4">
        <div className="flex items-start gap-3">
          <input className="w-6 h-6 mt-1 text-[#00236f] rounded focus:ring-[#00236f] focus:ring-2" id="consent" type="checkbox"/>
